  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column( crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Nome',style: TextStyle(fontSize: 25  ,color: Colors.black.withOpacity(0.3)),),
          const SizedBox(
            width: 300,
            height: 45,
            child: Text('João da silva',style: TextStyle(fontSize: 27  ,color: Colors.black87),),
          ),const Divider(),
          Text('CPF',style: TextStyle(fontSize: 25  ,color: Colors.black.withOpacity(0.3)),),
          const SizedBox(
            width: 300,
            height: 45,child: Text('000.000.000-00',style: TextStyle(fontSize: 27  ,color: Colors.black87),),
          ),const Divider(),
          Text('Endereço',style: TextStyle(fontSize: 25  ,color: Colors.black.withOpacity(0.3)),),
          const SizedBox(
            width: 300,
            height: 45,child: Text('Rua Floripa, n2, Gravatai',style: TextStyle(fontSize: 27  ,color: Colors.black87),),
          ),const Divider(),
          Text('Email',style: TextStyle(fontSize: 25  ,color: Colors.black.withOpacity(0.3)),),
          const SizedBox(
            width: 300,
            height: 45,child: Text('Joao@gmail.com',style: TextStyle(fontSize: 27  ,color: Colors.black87),),
          ),const Divider(),
          Text('Telefone',style: TextStyle(fontSize: 25  ,color: Colors.black.withOpacity(0.3)),),Container(
            width: 300,
            height: 45,color: const Color.fromRGBO(255, 255, 255, 1),child: const Text('51999999999',style: TextStyle(fontSize: 27  ,color: Colors.black87),),
          ),const Divider(),
        ],
      ),
